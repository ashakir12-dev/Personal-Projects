...
- pin_list:
  - {pin_num: '4', peripheral: GPIO, signal: 'PIO0, 13', pin_signal: PIO0_13/ADC_10, identifier: LED_RED, direction: OUTPUT, gpio_init_state: 'false', mode: inactive}
  - {pin_num: '5', peripheral: PINT, signal: 'PINT, 0', pin_signal: PIO0_12, identifier: S2}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    SYSCON->PINTSEL[0] = ((SYSCON->PINTSEL[0] &
                          ...
                          /* Pin number select for pin interrupt or pattern match engine input. (PIO0_0 to PIO0_5
                           * correspond to numbers 0 to 5. PIO0_7 to PIO0_30 correspond to numbers 7 to 30.): 0x0Cu */
