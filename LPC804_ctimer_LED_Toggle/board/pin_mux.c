...
- pin_list:
  - {pin_num: '13', peripheral: CTIMER0, signal: 'MATCH, 0', pin_signal: PIO0_20}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    /* TimerMatchChannel0 connect to P0_20 */
    SWM_SetMovablePinSelect(SWM0, kSWM_T0_MAT_CHN0, kSWM_PortPin_P0_20);
