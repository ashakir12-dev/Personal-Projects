...
#define BOARD_INITPINS_GPIO_9_GPIO GPIO                /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITPINS_GPIO_9_GPIO_PIN_MASK (1U << 9U) /*!<@brief GPIO pin mask */
#define BOARD_INITPINS_GPIO_9_PORT 0U                  /*!<@brief PORT device index: 0 */
#define BOARD_INITPINS_GPIO_9_PIN 9U                   /*!<@brief PORT pin number */
#define BOARD_INITPINS_GPIO_9_PIN_MASK (1U << 9U)      /*!<@brief PORT pin mask */
                                                       /* @} */
...
#define BOARD_INITPINS_LED_GREEN_GPIO_PIN_MASK (1U << 12U) /*!<@brief GPIO pin mask */
#define BOARD_INITPINS_LED_GREEN_PORT 0U                   /*!<@brief PORT device index: 0 */
#define BOARD_INITPINS_LED_GREEN_PIN 12U                   /*!<@brief PORT pin number */
#define BOARD_INITPINS_LED_GREEN_PIN_MASK (1U << 12U)      /*!<@brief PORT pin mask */
                                                           /* @} */
