...
- pin_list:
  - {pin_num: '16', peripheral: GPIO, signal: 'PIO0, 9', pin_signal: PIO0_9/ADC_4, direction: INPUT, mode: pullDown}
...
void BOARD_InitPins(void)
{
    ...
    GPIO_PinInit(BOARD_INITPINS_GPIO_9_GPIO, BOARD_INITPINS_GPIO_9_PORT, BOARD_INITPINS_GPIO_9_PIN, &GPIO_9_config);
    ...
    IOCON->PIO[13] = ((IOCON->PIO[13] &
                      ...
                      /* Selects function mode (on-chip pull-up/pull-down resistor control).: Pull-down. Pull-down
                       * resistor enabled. */
                      | IOCON_PIO_MODE(PIO0_9_MODE_PULL_DOWN));
}
